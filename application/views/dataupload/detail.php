        ...
        <?php if(!empty($table['master'])) {
            ...
            ?>
                ...
                <div class="col-md-12">
                    ...
                    <?php if(!empty($revisiikhtisar)){?>
                    <div class="row">
                        <div class="col-md-12">
                            <h3>Data Revisi Ikhtisar</h3>
                            <ul class="mailbox-attachments clearfix">
                            <?php $i=1; foreach($revisiikhtisar as $file) { ?>
                                <li>
                                    <span class="mailbox-attachment-icon"><i class="fa fa-file-pdf-o"></i></span>

                                    <div class="mailbox-attachment-info">
                                        <a href="#" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> File Ikhtisar <?=$i++?></a>
                                            <span class="mailbox-attachment-size">
                                            <a href="<?=base_url()?>berkas/ikhtisar/<?=$file->revisiikhtisarFile?>" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                                            </span>
                                    </div>
                                </li>
                            <?php }?>
...
<div class="box box-primary">
    ...
    <?php if(!empty($revisidetail)){?>
    <div class="row">
        <div class="col-md-12">
            <h3>Data Revisi Detail</h3>
            <ul class="mailbox-attachments clearfix">
            <?php $i=1; foreach($revisidetail as $file) { ?>
                <li>
                    <span class="mailbox-attachment-icon"><i class="fa fa-file-pdf-o"></i></span>

                    <div class="mailbox-attachment-info">
                        <a href="#" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> File Detail <?=$i++?></a>
                            <span class="mailbox-attachment-size">
                            <a href="<?=base_url()?>berkas/lampiran/<?=$file->revisidetailFile?>" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
                            </span>
                    </div>
                </li>
            <?php }?>
